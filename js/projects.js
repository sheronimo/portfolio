export const projects = [
	{
		...
		summary:
			'Simple app for calculating how many SNH48 Election votes you can buy with a specified budget and currency. Uses a currency converter API.',
		stack: 'React',
	...
	},
	{
		...
		name: 'Quizzical',
		summary:
			'Trivia quiz game app, with questions from the Open Trivia DB API.',
		stack: 'React',
	...
	{
		id: 9,
		name: 'FEM — Testimonials Grid Section',
		summary: 'Frontend Mentor challenge testing CSS Grid skills.',
		stack: 'HTML, CSS',
		repo: 'https://github.com/sheronimo/frontendmentor-testimonialsgrid',
		live: 'https://sheronimo.github.io/frontendmentor-testimonialsgrid/'
	},
	{
		id: 10,
		name: 'FEM — Social Proof Section',
		summary:
			'Frontend Mentor challenge testing cascading design using Flex or Grid.',
		stack: 'HTML, SCSS',
		repo: 'https://github.com/sheronimo/frontendmentor-socialproof',
		live: 'https://sheronimo.github.io/frontendmentor-socialproof/'
	},
	{
		id: 11,
		name: 'FEM — Single Price Grid Component',
		summary:
			'Frontend Mentor challenge testing a responsive grid layout. Built mobile-first.',
		stack: 'HTML, SCSS',
